...
export function getAllFilms(http: HttpClient, rootUrl: string, params?: GetAllFilms$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFilmResponse>> {
